...
class AnomalyWindow(BaseMonitorWindow):
    ...
    def _make_card(self, anomaly: dict) -> QFrame:
        ...
        name_font.setWeight(QFont.Weight.DemiBold)   # SemiBold
        ...
        desc_lbl.setFont(QFont("Inter", 13, QFont.Weight.Normal))
        ...
        badge.setMinimumHeight(52)
        badge.setFont(QFont("Inter", 11, QFont.Weight.DemiBold))
